...
public class WalletService {
    ...
    public void deductAmountById(Event event) throws NotFoundException, BadRequestException {
    ...
    public void deductAmountUserId(String id, double amount) throws BadRequestException, NotFoundException {
    ...
    public Double getBalById(long id) throws NotFoundException {
        Wallet wallet =  walletRepository.findById(id)
                .orElseThrow(()-> new NotFoundException("Wallet not found"));
